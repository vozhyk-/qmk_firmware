...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_LCTL, _______,          KC_LALT, NAV,     KC_SPC ,         KC_ENT,  SYM,     LSYM,             LANGSW,  KC_RCTL, SH_MON   \
  ),
  ...
  [_LANGSW] = LAYOUT(
    ...
    _______, _______, _______, _______, L_PL,    _______, _______,         _______, _______, _______, _______, _______, _______, DVP,     \
  ...
  [_SYM] = LAYOUT(
    _______, _______, KC_2,    KC_3,    KC_4,    KC_6,    _______,         _______, KC_6,    _______, _______, _______, _______, _______, \
    _______, KC_TILD, KC_1,    KC_4,    KC_5,    KC_6,    _______,         _______, KC_6,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_RBRC, \
    _______, KC_GRV,  _______, _______, _______, _______, _______,         _______, _______, KC_7,    _______, _______, KC_BSLS, KC_EQL,  \
  ...
  [_DVP_SYM] = LAYOUT(
    ...
    _______, KC_TILD, DVP_AMP, DVP_RCB, DVP_LPR, DVP_EQL, _______,         _______, DVP_EQL, DVP_RPR, DVP_PLS, DVP_RBR, DVP_EXC, DVP_AT,  \
    _______, DVP_DLR, _______, _______, _______, _______, _______,         _______, _______, DVP_AST, _______, _______, KC_BSLS, DVP_HSH, \
