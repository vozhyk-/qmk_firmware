...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    KC_LCTL, KC_LGUI, KC_LALT,          EISU,    LOWER,   KC_SPC ,         KC_ENT , RAISE,            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,          EISU,    LOWER,   KC_SPC ,         KC_ENT , RAISE,   KC_HOME,          KC_PGDN, KC_PGUP, KC_END   \
  ),
